...
const couscous = require("../../assets/perle-couscous.jpg");
const tajine = require("../../assets/perle-tajine.jpg");
const rechta = require("../../assets/perle-rechta.jpg");
const chakhchoukha = require("../../assets/perle-chakhchoukha.jpg");
const baghrir = require("../../assets/perle-baghrir.jpg");
const cornes = require("../../assets/perle-cornes.jpg");
const makrout = require("../../assets/perle-makrout.jpg");
const chorba = require("../../assets/perle-chorba.jpg");
const bourek = require("../../assets/perle-bourek.jpg");
const msemen = require("../../assets/perle-msemen.jpg");
const mhalbi = require("../../assets/perle-mhalbi.jpg");
const the = require("../../assets/perle-the.jpg");
const tm7 = require("../../assets/perle-tm7.jpg");
const founder = require("../../assets/perle-founder.jpg");
const liveImg = require("../../assets/perle-live.jpg");
