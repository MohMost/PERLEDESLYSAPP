...
const couscous = require("../../assets/perle/perle-couscous.jpg");
const tajine = require("../../assets/perle/perle-tajine.jpg");
const rechta = require("../../assets/perle/perle-rechta.jpg");
const chakhchoukha = require("../../assets/perle/perle-chakhchoukha.jpg");
const baghrir = require("../../assets/perle/perle-baghrir.jpg");
const cornes = require("../../assets/perle/perle-cornes.jpg");
const makrout = require("../../assets/perle/perle-makrout.jpg");
const chorba = require("../../assets/perle/perle-chorba.jpg");
const bourek = require("../../assets/perle/perle-bourek.jpg");
const msemen = require("../../assets/perle/perle-msemen.jpg");
const mhalbi = require("../../assets/perle/perle-mhalbi.jpg");
const the = require("../../assets/perle/perle-the.jpg");
const tm7 = require("../../assets/perle/perle-tm7.jpg");
const founder = require("../../assets/perle/perle-founder.jpg");
const liveImg = require("../../assets/perle/perle-live.jpg");
